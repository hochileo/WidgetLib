package com.example.widgetcustomlib;
...
public class FloatingEditText extends EditText {
        ...
        Drawable drawable = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                ...
                if (mVerified) {
                    ...
                    canvas.drawRect(rect, mHintPaint);
                    mHintPaint.setColor(mErrorColor);
                    mHintPaint.setTextSize(getTextSize() * 0.7f);
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(getHint())) {
            ...
            float minHintY = getBaseline() + getPaint().getFontMetricsInt().top + getScrollY() - dpToPx(2);
            float textSize;
            float hintY;
